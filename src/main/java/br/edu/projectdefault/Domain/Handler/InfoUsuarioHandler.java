...
import br.edu.projectdefault.Domain.Commands.InfoUsuarioCommand.Inputs.AtualizarInfoUsuarioCommand;
import br.edu.projectdefault.Domain.Commands.InfoUsuarioCommand.Inputs.DeletarInfoUsuarioCommand;
import br.edu.projectdefault.Domain.Commands.InfoUsuarioCommand.Inputs.SalvarInfoUsuarioCommand;
import br.edu.projectdefault.Domain.Commands.InfoUsuarioCommand.Outputs.InfoUsuarioTO;
import br.edu.projectdefault.Infrastructure.repository.InfoUsuarioRepository;
...
public class InfoUsuarioHandler implements BaseHandler<InfoUsuarioTO, SalvarInfoUsuarioCommand, AtualizarInfoUsuarioCommand, DeletarInfoUsuarioCommand>
{
    ...
    {
        command.InfoUsuarioEntity = _repository.getOne(id);
        command.configuration();
